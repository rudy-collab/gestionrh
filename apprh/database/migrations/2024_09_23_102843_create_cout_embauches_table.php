...
return new class extends Migration
{
    ...
    {
        Schema::create('cout_embauches', function (Blueprint $table) {
            $table->id();
            $table->string('montant1');
            $table->string('montant2');
            $table->string('montant3');
            $table->string('montant4');
            $table->string('montant5');
            $table->string('montant6');
            $table->string('montant7');
            $table->string('montant8');
            $table->string('montant9');
            $table->string('montant10');
    ...
    {
        Schema::dropIfExists('cout_embauches');
    }
};
