<x-app-layout>
    ...
    <div class="flex lg:justify-center lg:col-start-2 upe">
        @if ($precedUrl == 'employedetails'.$cand->id)

        <span><a href="{{ route('employedetails', ['id' => $cand->id]) }}"><button class='btn btn-dark'>
                    <<<Back</button></a></span>
    ...
    <div class="flex justify-center lg:col-start-2 ">
        <div class='shadow-lg rounded  cons px-4 py-4 haut' id='apdf'>
            ...
            <ul>
                ...
                <li><strong>Representé par : </strong> {{ $cand->name }}</li>
                <li><strong>Telephone : </strong></strong> {{ $cand->telephone }}</li>
                <li><strong>Fonction : {{ $cand->role}}</strong></li>
            </ul>
            <br>
            ...
            <ul>
                ...
                <li><strong>Date de naissance : </strong> {{ $cand->adresse }}</li>
                <li><strong>Telephone : </strong></strong> {{ $cand->telephone }}</li>
            </ul><br>
            ...
            <p>Fait å <strong>{{ $cand->adresse }}</strong> le ...</p>
            ...
            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                <button type='button' class='btn btn-dark mt-3'><a
                    href="{{ route('telechargercontratemployes', ['id' => $cand->id, 'download' => true]) }}">Telecharger</a></button>
                    <button type="button" class="btn btn-outline-dark  mx-3" ><a href =''>Modifier Contrat</a></button>
