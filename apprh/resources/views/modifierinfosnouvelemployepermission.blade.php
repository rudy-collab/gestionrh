<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Actualisé les infos de ') }} {{ $employe->name }}
        </h2>
    </x-slot>
   
   
    <form action="{{ route('modifierinfosnouvelemployepermission', ['id'=>$employe->id]) }}" method='post' enctype="multipart/form-data">
        @csrf
                ...
                @endif
                   ...
                   <br> <hr class='hrs'><br>
                    ...
                    <div class="mb-3 filess">
                        ...
                        <input class="form-control form-control-sm" id="formFileSm" type="hidden"
                            name='ids' value={{ $employe->id }}>
                    </div>
                    <br><hr><br>
  ...
  <form action="{{ route('addmissionnouvelemployepermission', ['id'=>$employe->id]) }}" method="post">
        @csrf 
...
<form action="{{ route('addavantagenouvelemployepermission', ['id'=>$employe->id]) }}" method="post">
    @csrf
