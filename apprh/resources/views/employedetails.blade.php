                ...
                <table class="shadow-lg table table-light table-striped cons">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                @if ($firstEmploi)
                                <td class='text-center'> {{ $employes->voiremploye->offreemploi->reference}}</td>
                                @elseif (!$firstEmploi)
            ...
            <div class="flex lg:justify-center lg:col-start-2 ">
                <table class="shadow-lg table table-light table-striped cons">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td class='text-center'> <a href="{{ asset('storage/' . $employes->voiremploye->cv) }}"
                                    target="_blank">Télécharger le CV</a></td>
                               
                                <td class='text-center'> {{ $employes->societe }}</td>
                                <td class='text-center'><a href="{{ route('voircontratemploye',['id'=>$employes->id]) }}">Voir Contrat</a></td>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @endif
            @if ($lesavantages->avantage3 =='non')
            <p></p>
                @elseif ($lesavantages->avantage3 !=='non')
                <li>{{ $lesavantages->avantage3 }}</li>
            @endif
            @if ($lesavantages->avantage4 =='non')
            <p></p>
                @elseif ($lesavantages->avantage4 !=='non')
                <li>{{ $lesavantages->avantage4 }}</li>
            @endif
            @if ($lesavantages->avantage5 =='non')
            <p></p>
                @elseif ($lesavantages->avantage5 !=='non')
                <li>{{ $lesavantages->avantage5 }}</li>
            @endif
            @if ($lesavantages->avantage6 =='non')
            <p></p>
                @elseif ($lesavantages->avantage6 !=='non')
                <li>{{ $lesavantages->avantage6 }}</li>
            @endif
            @if ($lesavantages->avantage7 =='non')
            <p></p>
                @elseif ($lesavantages->avantage7 !=='non')
                <li>{{ $lesavantages->avantage7 }}</li>
            @endif
            @if ($lesavantages->avantage8 =='non')
            <p></p>
                @elseif ($lesavantages->avantage8 !=='non')
                <li>{{ $lesavantages->avantage8 }}</li>
            @endif
            @if ($lesavantages->avantage9 =='non')
            <p></p>
                @elseif ($lesavantages->avantage9 !=='non')
                <li>{{ $lesavantages->avantage9 }}</li>
            @endif
            @if ($lesavantages->avantage10 =='non')
            <p></p>
                @elseif ($lesavantages->avantage10 !=='non')
                <li>{{ $lesavantages->avantage10 }}</li>
            @endif
          <p></p>
        </div>
