        ...
        <div class='shadow-lg rounded  cons px-4 py-4 haut' id='apdf'>
            ...
            <div class="flex justify-center lg:col-start-2 upe">
                ...
                <button type='button' class='btn btn-dark mt-3'><a
                    href="{{ route('telechargercontratemploye', ['id' => $cand->id, 'download' => true]) }}">Telecharger</a></button>
                    <button type="button" class="btn btn-outline-dark  mx-3" ><a href ="{{ route('modifierinfosnouvelemployepermission',['id' => $cand->id]) }}">Modifier Contrat</a></button>
            </div>
        </div>
