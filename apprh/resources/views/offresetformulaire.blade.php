...
<body class="font-sans antialiased   text-black/50">
    ...
    <div class="flex justify-center lg:col-start-2 up">
        <div class='shadow-lg rounded  cons px-4 py-4 haut'>
            <h3><strong>Societe :</strong> {{ $data->user->societe }}</h3>
            <h3><strong>Reference de l'offre d'emploi : </strong>{{ $data->reference }} </h3>
            <br />
            <h4 class='text-center'><strong>Titre : </strong>{{ $data->titre }}</h4></br>
            </br>
            <hr /><br />
            <p class='text-center'><strong>Description</strong></p><br />
    ...
    <div class=" flex justify-center lg:col-start-2 buts">
        <button class='btn btn-dark' data-bs-toggle="modal" data-bs-target="#staticBackdrop">Postuler</button>
    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('createcandidat', ['id' => $data->id]) }}" method='post'
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput2" name='prenom'>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Telephopne</label>
                            <input type="text" class="form-control" id="exampleFormControlInput4" name='telephone'>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Adresse</label>
                            <input type="text" class="form-control" id="exampleFormControlInput4" name='adresse'>
                        </div>
                        <div class="mb-3">
